        ...
        async def _call():
            ...
            async with server._rpc_lock, _track_inflight_rpc(
                ...
                try:
                    ...
                    # Create the watcher only when there is an RPC to race,
                    # and retain that same awaitable. Calling its factory as a
                    # capability probe leaked an unused coroutine on every call.
                    _watch_coro = (
                        _watch_children()
